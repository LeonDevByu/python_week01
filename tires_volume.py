# 01 Prove: Assignment Milestone
# Author: EDWIN LEON MATIAS
...
# is the aspect ratio. The third number is the diameter in inches
# of the wheel that the tire fits. The volume of space inside a
